...
def run(
    ...
    project=ROOT / "runs6519/val",  # save to project/name
...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "yolov5dt6519.pt", help="model path(s)")
    ...
    parser.add_argument("--project", default=ROOT / "runs6519/val", help="save to project/name")
